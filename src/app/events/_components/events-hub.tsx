...
import { Calendar, Video, Clock, ExternalLink, HelpCircle } from "lucide-react"
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-4">
            {upcomingEvents.map((event) => (
              <div key={event.title} className="rounded-xl border border-border/60 bg-card p-5 space-y-3 shadow-sm">
